  ...
  <div class='batch-table'>
    ...
    <div v-transfer-dom>
      <aui-popup v-model="showPopup" height="100%">
        <div>
          <aui-popup-header class="popup-header" left-text="关闭" :title="batchView.title" :show-bottom-border="false" @click-left="cancle" style='font-size:18px;background-color:#33c3cf'></aui-popup-header>
