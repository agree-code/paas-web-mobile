...
<script>
    export default {
        ...
        mounted () {
            this.changeType = 1;
            this.$store.state.headTitle = '我的报销'
        ...
        methods: {
            ...
            goReimburse(){
                this.$router.push("/home/reimDetail")
            },
            loadMore () {
...
<style>
    .expense-account .aui-panel {
        margin-top: 15px;
    }

    .expense-account .aui-panel:before {
        border-top: 0;
    }

    .expense-account .aui-panel:after {
        border-bottom: 0;
    }

    .expense-account .aui-panel__hd:after {
        left: 0;
    }

    .expense-account .aui-media-box__info {
        position: absolute;
        right: 18px;
        top: 20px;
        height: 12px;
    ...
    .expense-account .aui-media-box__info__meta {
        width: 0;
        padding-right: 0;
    }

    .expense-account .aui-media-box__info__meta:nth-of-type(2) {
        width: 50px;
    }

    .expense-account .aui-media-box:before {
        left: 75px;
        border-top: 1px solid #e6e6e6;
    }

    .expense-account .aui-media-box__info__meta_extra {
        padding-left: 0;
    }
</style>
